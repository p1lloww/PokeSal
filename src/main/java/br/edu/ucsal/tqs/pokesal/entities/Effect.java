...
public interface Effect {
    /**
     * Aplica este efeito ao PokeSal informado. É sempre invocado exatamente uma vez, no momento em que o item correspondente é utilizado.
     *
    ...
    /**
     * Reverte este efeito no PokeSal informado. É invocado apenas para efeitos temporários, exatamente uma vez, no turno em que a expiração está agendada.
     *
     ...
     * @return true se o efeito é temporário e será revertido posteriormente; false se o efeito é instantâneo e permanente
     */
