...
/**
 * Representa uma habilidade passiva que um PokeSal carrega, reagindo automaticamente a eventos de batalha como entrar em campo, sofrer dano ou o fim de um turno, sem exigir ação do jogador.
 * Cada implementação concreta define apenas os eventos que lhe são relevantes, os demais métodos herdam o comportamento neutro (sem efeito) declarado nesta interface.
 */
public interface Passive {
    ...
    /**
     * Reage ao evento de o PokeSal dono desta passiva sofrer dano, permitindo aplicar efeitos condicionais como buffs ativados por HP baixo.
     * @param self o PokeSal dono desta passiva
    ...
    /**
     * Reage ao fim de um turno de batalha, permitindo efeitos recorrentes como regeneração de HP ou custo de manutenção de um buff ativo.
     * @param self o PokeSal dono desta passiva
     */
    void onTurnEnd(PokeSal self);

    /**
     * Reage ao momento em que o PokeSal dono desta passiva executa um ataque, retornando um multiplicador de dano adicional. Usado por passivas sensíveis ao terreno da batalha.
     * @param self o PokeSal dono desta passiva
    ...
    /**
     * Indica se esta passiva impede a aplicação de qualquer condição de status negativa no PokeSal dono.
     * @param self o PokeSal dono desta passiva
