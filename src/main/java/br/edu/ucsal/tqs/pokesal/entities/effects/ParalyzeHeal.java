 ...
 * restaura mais HP e cura a paralisia quando o PokeSal alvo está paralisado.
 */
public class ParalyzeHeal implements Effect {
  ...
  public void applyEffect(PokeSal pokeSal) {
    if (pokeSal.getStatusCondition() instanceof Paralyzed) {
