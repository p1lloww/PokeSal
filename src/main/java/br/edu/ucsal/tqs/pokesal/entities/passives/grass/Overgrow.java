...
/**
 * Passiva de tipo Planta que aumenta o ATK do PokeSal em 50% enquanto seu HP estiver abaixo de 1/3
 * do máximo. O buff é ativado e desativado automaticamente conforme o HP cruza esse limite,
 * reagindo a cada dano recebido.
 */
public class Overgrow implements Passive {
  ...
  public void onDamageTaken(PokeSal self, PokeSal opponent, double damageTaken) {
    boolean shouldBeActive = self.getElementType() == ElementType.PLANT
